package cn.luojs.uiwidgetsapp.adapter;
...
public class MyBaseExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private ArrayList<ElvGroup> gData;
    private ArrayList<ArrayList<ElvItem>> iData;
    private Context mContext;

    public MyBaseExpandableListAdapter(ArrayList<ElvGroup> gData,ArrayList<ArrayList<ElvItem>> iData, Context mContext) {
        this.gData = gData;
        this.iData = iData;
    ...
    @Override
    public ElvGroup getGroup(int groupPosition) {
        return gData.get(groupPosition);
    }

    @Override
    public ElvItem getChild(int groupPosition, int childPosition) {
