...
public class SimpleNtfTestActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_simple_ntf_test);
...
//			notification.defaults = Notification.DEFAULT_ALL;
                Intent intent = new Intent(this, SimpleNtfActivity.class);
